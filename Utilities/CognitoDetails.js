...
const createCognitoAuth = () => {
  ...
  const auth = new CognitoAuth({
    ...
    RedirectUriSignIn: "http://localhost:3000/Redirect",
...
const getCognitoSignInUri = () => {
  ...
  const signinUri = "https://driveinapp.auth.us-east-1.amazoncognito.com/login?client_id=1ftvsvppqssummhdmja3mkqptp&response_type=token&scope=email+openid+profile&redirect_uri=http://localhost:3000/Redirect"
  return signinUri
}
