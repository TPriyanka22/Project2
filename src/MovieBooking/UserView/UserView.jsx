            ...
            <div>
                ...
                <Container fluid>
                    ...
                    <Row style={{ marginTop: 10 }}>
                        <Col xl={7} style={{ margin: 10, borderRadius: 5, marginLeft: 80, height: (window.innerHeight) - 150, overflowY: "scroll" }}>
                            ...
                            <div className='card-container user-view text-center'>
